...
- [README.md](../../README.md)
- [ТЗ](<../intro/ТЗ на мат. модель стенда.md>)
- [ТТ](<../intro/ТТ общие.md>)
...
| --- | --- | --- |
| Требования и коммуникации| @EugeniusMiroshnichenko `Мирошниченко Евгений` | ТТ/ТЗ, общение с другими командами / заказчиком |
...
| "Простая" модель | @EugeniusMiroshnichenko `Мирошниченко Евгений` | "Простая" математическая модель тестового стенда |
...
- верификация модели;
- верификация / отладка рабочего цикла;
